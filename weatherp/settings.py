"""
Django settings for weatherp project.
...
SECRET_KEY = 'django-insecure-%m6dwpcxa-n&b#x*i80c=s%lfbl1m8@d2!)ddri@m(vvgtd+@g'
...
WSGI_APPLICATION = 'weatherp.wsgi.application'
